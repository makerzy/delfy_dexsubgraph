...
export class DelfyFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save DelfyFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save DelfyFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("DelfyFactory", id.toString(), this);
  }

  static load(id: string): DelfyFactory | null {
    return store.get("DelfyFactory", id) as DelfyFactory | null;
  }
...
export class DelfyDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save DelfyDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save DelfyDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("DelfyDayData", id.toString(), this);
  }

  static load(id: string): DelfyDayData | null {
    return store.get("DelfyDayData", id) as DelfyDayData | null;
  }
